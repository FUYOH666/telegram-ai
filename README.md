...
- **Глобальные лимиты** - защита на уровне аккаунта (25 сообщений/минуту, 500/час) для предотвращения блокировок Telegram
- **Адаптивные лимиты** - автоматическое снижение лимитов при получении FloodWait от Telegram и постепенное восстановление
- **Лимиты по типам чатов** - разные лимиты для личных чатов (20/мин), групп (10/мин) и каналов (5/мин)
...
Система автоматически адаптируется к лимитам Telegram: при получении FloodWait лимиты снижаются на 20%, а при отсутствии FloodWait в течение 10 минут восстанавливаются на 5% за период.
