            ...
            if user_first_name:
                ...
                if self.sales_flow and self.sales_flow.enabled:
                    ...
                    if max_response_length:
                        ...
                        # Если лимита нет, все равно напоминаем о разумной длине (Telegram лимит 4096)
                        length_info = "\n\nВАЖНО: Telegram ограничивает сообщения до 4096 символов. Если ответ очень длинный, разбей его на несколько сообщений или сделай более кратким."
